...
public class L1CargoshipFront extends CommandGroup {
  /**
   * Add your docs here.
   */
  public L1CargoshipFront(boolean isLeftSide) {
    ...
    addSequential(new DriveUntilDistance(0.8, 60));
    addSequential(new DriveUntilDistance(0.4, 10));
    addSequential(new ElevateToHeight(0));
    addSequential(new DriveUntilTarget(0.5, 40), 1.5);
    addSequential(new DriveUntilTarget(0.2, 10), 1);
    addParallel(new DriveUntilTarget(0.5, 45), 1.9);
    ...
    addSequential(new RotateAngle(isLeftSide ? -135 : 135));
  }
